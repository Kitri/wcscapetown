  ...
  return (
    ...
    >
      <div className="max-w-[700px] mx-auto text-center">
        <h2 className="font-spartan font-semibold text-[24px] md:text-[32px] mb-8">
          Get in Touch
        </h2>
        ...
        <div className="flex flex-col gap-6 items-center">
          ...
          <a
            ...
            className="flex items-center gap-3 text-lg hover:text-pink-accent transition-colors"
          >
            <svg
              width="24"
              height="24"
